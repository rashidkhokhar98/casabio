...
function Hero() {
  return (
    ...
    <div className="container">
      <div className="row">
      <div className="col-lg-6 order-1 order-lg-1 hero-img" data-aos="zoom-in" data-aos-delay={200}>
        <img src="https://i.ibb.co/zH7XBs1/logo.png" className="img-fluid animated" alt="hero-img" border="0" />
        </div>
      ...
      <div className="row justify-content-center pt-5 d-lg-flex">
